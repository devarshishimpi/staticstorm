              ...
              return (
                <div key={project._id}>
                  <div className="rounded-2 columns-2 py-5">
                    <h5 className="mt-2 text-xl font-bold tracking-tight text-white">
                      {" "}
                    ...
                    <div className="float-right">
                      <a
                        ...
                        target="_blank"
                        type="button"
                        className="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800 cursor-pointer"
                      >
                        Visit
                      </a>
                      <button
